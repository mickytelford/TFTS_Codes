...
for /l %%w in (1,1,%numWeeks%) do (
    ...
    for /l %%i in (0,1,%numGroups%) do (
        ...
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Footage\SD_1
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Footage\SD_2
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Sound\Extras
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Sound\Music
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Sound\Filmed
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Graphics\Graphics
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Graphics\Titles
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Graphics\Images
        mkdir %drive%\Week_%%w\Assets\Group_!groupLetter!\Effects
        
        REM Create directories under Exports
        mkdir %drive%\Week_%%w\Exports\Group_!groupLetter!
        
        REM Create directories under Extras
        mkdir %drive%\Week_%%w\Extras\Group_!groupLetter!\BTS_Photos
        mkdir %drive%\Week_%%w\Extras\Group_!groupLetter!\Marketing
        mkdir %drive%\Week_%%w\Extras\Group_!groupLetter!\Schedules
        mkdir %drive%\Week_%%w\Extras\Group_!groupLetter!\Submission_Sheets
        mkdir %drive%\Week_%%w\Extras\Group_!groupLetter!\Budget
    )
)
